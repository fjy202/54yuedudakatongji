...
/* function QQMessageParser(content_) {
13:29:07
方霁云 2019/9/7 13:29:07

13:44:19
方霁云 2019/9/7 13:44:19
/亲亲
13:49:37
方霁云 2019/9/7 13:49:37
[图片]

    var headerreg=/(.+) ([0-9][0-9][0-9][0-9])\//
    var result=[]
    var lines=content_.split("\n")
    alert(lines.length)
    lines.forEach(
        (value,index)=>{
            alert(headerreg.test(value))
            if(headerreg.test(value)){
                console.log(3)
                var name=value.split("&nbsp;")[0]
                var content=lines[index+1]
                var obj={
                    name:name,
                    content:content
                }
